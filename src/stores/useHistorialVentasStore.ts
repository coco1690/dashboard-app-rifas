...
//   // Información del cliente (actualizado para coincidir con tu vista)
//   cliente_nombre: string
//   cliente_cedula: string
//   cliente_email?: string
//   cliente_telefono?: string // Cambiado de telefono a phone en la vista
...
//         query = query.eq('agencia_id', filtros.agenciaId)
//       }
...
//       if (filtros.clienteCedula) {
//         query = query.eq('cliente_cedula', filtros.clienteCedula)
//       }
