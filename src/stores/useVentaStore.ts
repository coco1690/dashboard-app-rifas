...
//   estadoPago?: EstadoPago // Nuevo campo opcional
//   referencia?: string
...
//       // Éxito con mensaje que incluye información del paquete
...
//       const mensajeExito = `Venta realizada exitosamente: ${tipoPaquete} boleto${boletos.length > 1 ? 's' : ''} ${estadoTexto}${boletos.length > 1 ? 's' : ''} por $${totalEsperado.toLocaleString()}`
